...
## Project Structure
The team primarly used html, css, js, and bootstrap version 4 and greater to construct our beta prototype. As for the structure of our application we decided to focus on the ease of use for our users. Which heavily relied on labeling and taking our color choices into consideration when developing. Our main tasks focus no the artists perspective from the application on the following pages:
